    ...
    <main>
      ...
      <div className="pt-20 pb-12">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl font-bold text-center mb-12">Galeria de Fotos de Eventos</h1>
          ...
          <div className="space-y-16">
            ...
            {publicEvents.length === 0 && (
              <p className="text-center text-gray-500">Nenhum evento público encontrado.</p>
            )}
          </div>
        </div>
      </div>
